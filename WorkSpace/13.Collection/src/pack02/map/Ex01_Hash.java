...
public class Ex01_Hash {
	public static void main(String[] args) {
		//Collection자료구조는 <> 클래스타입만 넣을수있게 구조가 되어있음.
		...
		set.add("jsp/servlet");
		set.add("oracledb");
		set.add("java");//HashSet은 해시코드로 비교하여 중복된데이터가 있다면 마지막 데이터만 유지가됨.
								//데이터 건수가 몇건이될까???
		...
		Iterator<String> iterator = set.iterator();//set자료구조를 탐색할수있는 기능을 가짐(반복자)
